          ...
          builder: (context, snap) {
            ...
            return NestedScrollView(
              ...
              body: TabBarView(
                children: [
                  const _OverviewTab(),
                  // ECHTER Bilder-Tab mit Upload, Pagination etc.
                  ProfileImagesTab(
...
// _ImagesTab ENTFERNT – wird jetzt durch ProfileImagesTab ersetzt

class ProfileImagesTab extends StatelessWidget {
  const ProfileImagesTab({required this.ownerId, super.key});
  final String ownerId;

  @override
  Widget build(BuildContext context) {
    // Simple placeholder implementation until the full images tab is available.
    return _PlaceholderPanel(
      title: 'Bilder',
      lines: const [
        'Hier würde die Bildergalerie für den Nutzer geladen.',
        'Upload, Pagination und Detailansichten kommen später.',
      ],
    );
  }
}
